        ...
        child: Container(
          decoration: BoxDecoration(
            ...
            boxShadow: [
              ...
              if (_isPressed) BoxShadow(color: AppColors.primary.withValues(alpha: 0.1), blurRadius: 16),
            ],
          ),
          child: Column(
              ...
              Stack(
                children: [
                  ...
                  if (widget.video.duration != Duration.zero)
                    Positioned(bottom: 6.h, right: 6.w, child: Container(padding: EdgeInsets.symmetric(horizontal: 6.w, vertical: 2.h), decoration: BoxDecoration(color: Colors.black87, borderRadius: BorderRadius.circular(4.r)), child: Text(widget.video.durationFormatted, style: TextStyle(color: Colors.white, fontSize: 10.sp, fontWeight: FontWeight.w600)))),
                  Positioned.fill(child: Center(child: Container(width: 44.w, height: 44.h, decoration: BoxDecoration(shape: BoxShape.circle, color: Colors.black.withValues(alpha: 0.5), boxShadow: [BoxShadow(color: Colors.black.withValues(alpha: 0.3), blurRadius: 8)]), child: Icon(Icons.play_arrow, color: Colors.white, size: 28.sp)))),
                ],
              ),
              Expanded(
                child: Padding(
                  ...
                  child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                    Text(widget.video.title, maxLines: 2, overflow: TextOverflow.ellipsis, style: TextStyle(color: Colors.white, fontSize: 12.sp, fontWeight: FontWeight.w500, height: 1.3)),
                    Text(widget.video.channelName, maxLines: 1, overflow: TextOverflow.ellipsis, style: TextStyle(color: AppColors.textMuted, fontSize: 11.sp)),
                  ]),
                ),
              ),
            ],
